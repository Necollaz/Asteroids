...
namespace AsteroidGame.Scripts.Domain.Collision.Rules
{
    public sealed class CollisionCategoryPolicy
    {
        ...
        public bool IsBullet(CollisionCategory category) => category == CollisionCategory.Bullet;

        public bool IsLaser(CollisionCategory category) => category == CollisionCategory.Laser;
    }
}